    ...
    public partial class AddOutboxMessages : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_items", x => new { x.OrderId, x.MenuItemId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "menu_items",
                columns: new[] { "Id", "IsAvailable", "Name", "Price", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, true, "排骨便當", 110m, seedDate },
                    { 2, true, "雞腿便當", 120m, seedDate },
                    { 3, true, "鯖魚便當", 130m, seedDate },
                    { 4, true, "素食便當", 100m, seedDate }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_outbox_messages_AggregateId",
